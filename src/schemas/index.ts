...
import TOrder from './TOrder.json'
...
import IReissueParams from './IReissueParams.json'
import IBurnParams from './IBurnParams.json'
import ILeaseParams from './ILeaseParams.json'
import ICancelLeaseParams from './ICancelLeaseParams.json'
import IMassTransferParams from './IMassTransferParams.json'
import ISetScriptParams from './ISetScriptParams.json'
...
import InvokeScriptPayment from './InvokeScriptPayment.json'
...
import TTxOrTxArray from './TTxOrTxArray.json'
export default {
  TTx,
  AliasTransaction,
  IssueTransaction,
